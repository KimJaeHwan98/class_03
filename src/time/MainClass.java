...
public class MainClass {
 ...
 while(true) {
	...
	switch(num) {
	case 1 : time.setStartTime();
	break;
	case 2 : String sTime = time.getStartTime();
	System.out.println(sTime);
	break;
	case 3 :time.setEndTime();
	break;
	case 4 :String eTime = time.getEndTime();
	break;
	case 5 :System.out.println(time.getResultTime());
	break;
	}
	}
}
